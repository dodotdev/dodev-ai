...
function SpaceSettingsRoute() {
  const { id } = useParams({ from: "/dashboard/spaces/$id/settings" })
  const { tab: tabFromUrl } = Route.useSearch()
  const navigate = useNavigate({ from: "/dashboard/spaces/$id/settings" })
                      ...
                      return (
                        <li key={p._id as string}>
                          <Link
                            ...
                            params={{ id: spaceId, projectId: p._id as string }}
