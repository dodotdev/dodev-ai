...
export const Route = createFileRoute("/dashboard/spaces/$id/projects/$projectId/settings")({
  component: ProjectSettingsRoute,
})

function ProjectSettingsRoute() {
  const { id, projectId } = useParams({
    from: "/dashboard/spaces/$id/projects/$projectId/settings",
  })
  const navigate = useNavigate({ from: "/dashboard/spaces/$id/projects/$projectId/settings" })
  ...
  useEffect(() => {
    if (project === null) {
      void navigate({
        to: "/dashboard/spaces/$id/projects",
        params: { id },
        replace: true,
      })
    }
  ...
  async function handleArchive() {
    ...
    try {
      ...
      void navigate({ to: "/dashboard/spaces/$id/projects", params: { id } })
    } finally {
      setSaving(false)
    }
  }
    ...
    <div className="mx-auto max-w-3xl">
      ...
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          ...
          <Link to="/dashboard/spaces/$id/settings" params={{ id }} className="underline">
            space settings
          </Link>
          .
        </p>
